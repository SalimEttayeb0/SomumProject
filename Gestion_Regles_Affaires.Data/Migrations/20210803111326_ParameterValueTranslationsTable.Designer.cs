...
namespace Gestion_Regles_Affaires.Data.Migrations
{
    ...
    [Migration("20210803111326_ParameterValueTranslationsTable")]
    partial class ParameterValueTranslationsTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Gestion_Regles_Affaires.Data.Entities.BusinessRulesParameterValueTranslations", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("BusinessRulesParameterValueID")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("BusinessRulesParameterValueID");

                    b.ToTable("ParameterValueTranslations");

                    b.HasData(
                        new
                        {
                            Id = 1,
                            BusinessRulesParameterValueID = 1,
                            LanguageCode = "fr",
                            TranslationName = "Classification 1"
                        },
                        new
                        {
                            Id = 2,
                        ...
                        {
                            Id = 3,
                            BusinessRulesParameterValueID = 2,
                            LanguageCode = "fr",
                            TranslationName = "Classification 2"
                        },
                        new
                        {
                            Id = 4,
                        ...
                        {
                            Id = 5,
                            BusinessRulesParameterValueID = 3,
                            LanguageCode = "fr",
                            TranslationName = "Classification 3"
                        },
                        new
                        {
                            Id = 6,
                        ...
                        {
                            Id = 7,
                            BusinessRulesParameterValueID = 4,
                            LanguageCode = "fr",
                            TranslationName = "Classification 4"
                        },
                        new
                        {
                            Id = 8,
                        ...
                        {
                            Id = 9,
                            BusinessRulesParameterValueID = 5,
                            LanguageCode = "fr",
                            TranslationName = "modèle horaire d'appel 1"
                        },
                        new
                        {
                            Id = 10,
                            BusinessRulesParameterValueID = 5,
                            LanguageCode = "en",
                            TranslationName = "Call schedule model 1"
                        },
                        new
                        {
                            Id = 11,
                            BusinessRulesParameterValueID = 6,
                            LanguageCode = "fr",
                            TranslationName = "modèle horaire d'appel 2"
                        },
                        new
                        {
                            Id = 12,
                            BusinessRulesParameterValueID = 6,
                            LanguageCode = "en",
                            TranslationName = "Call schedule model 2"
                        },
                        new
                        {
                            Id = 13,
                            BusinessRulesParameterValueID = 7,
                            LanguageCode = "fr",
                            TranslationName = "modèle horaire d'appel 3"
                        },
                        new
                        {
                            Id = 14,
                            BusinessRulesParameterValueID = 7,
                            LanguageCode = "en",
                            TranslationName = "Call schedule model 3"
                        },
                        new
                        {
                            Id = 15,
                            BusinessRulesParameterValueID = 8,
                            LanguageCode = "fr",
                            TranslationName = "modèle horaire d'appel 4"
                        },
                        new
                        {
                            Id = 16,
                            BusinessRulesParameterValueID = 8,
                            LanguageCode = "en",
                            TranslationName = "Call schedule model 4"
                        },
                        new
                        {
                            Id = 17,
                            BusinessRulesParameterValueID = 9,
                            LanguageCode = "fr",
                            TranslationName = "groupe de contact 1"
                        },
                        new
                        {
                            Id = 18,
                            BusinessRulesParameterValueID = 9,
                            LanguageCode = "en",
                            TranslationName = "contact group 1"
                        },
                        new
                        {
                            Id = 19,
                            BusinessRulesParameterValueID = 10,
                            LanguageCode = "fr",
                            TranslationName = "groupe de contact 2"
                        },
                        new
                        {
                            Id = 20,
                            BusinessRulesParameterValueID = 10,
                            LanguageCode = "en",
                            TranslationName = "contact group 2"
                        },
                        new
                        {
                            Id = 21,
                            BusinessRulesParameterValueID = 11,
                            LanguageCode = "fr",
                            TranslationName = "groupe de contact 3"
                        },
                        new
                        {
                            Id = 22,
                            BusinessRulesParameterValueID = 11,
                            LanguageCode = "en",
                            TranslationName = "contact group 3"
                        },
                        new
                        {
                            Id = 23,
                            BusinessRulesParameterValueID = 12,
                            LanguageCode = "fr",
                            TranslationName = "groupe de contact 4"
                        },
                        new
                        {
                            Id = 24,
                            BusinessRulesParameterValueID = 12,
                            LanguageCode = "en",
                            TranslationName = "contact group 4"
                        });
                });
            ...
            modelBuilder.Entity("Gestion_Regles_Affaires.Data.Entities.BusinessRulesParameterValueTranslations", b =>
                {
                    b.HasOne("Gestion_Regles_Affaires.Data.Entities.BusinessRulesParameterValue", "BusinessRulesParameterValue")
                        .WithMany("BusinessRulesParameterValueTranslations")
                        .HasForeignKey("BusinessRulesParameterValueID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("BusinessRulesParameterValue");
                });
            ...
            modelBuilder.Entity("Gestion_Regles_Affaires.Data.Entities.BusinessRulesParameterValue", b =>
                {
                    b.Navigation("BusinessRulesParameterValueTranslations");
                });
